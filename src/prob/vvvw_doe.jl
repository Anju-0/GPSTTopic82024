...
"""
function solve_mc_vvvw_doe(data::Union{Dict{String,<:Any},String},  solver; kwargs...)
    return _PMD.solve_mc_model(data, _PMD.IVRENPowerModel, solver, build_mc_vvvw_doe; kwargs...)
end
...
"""
function build_mc_vvvw_doe(pm::_PMD.AbstractExplicitNeutralIVRModel)
